...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <p style={{ color: "rgba(255, 255, 255, 0.9)" }}>
            Project Delhi is a unified platform connecting civic-minded
      ...
      {/* Trust Bar */}
      <div id="partners" className="trust-bar">
        <div className="container">
          <p
            style={{
              textAlign: "center",
          ...
          >
            Trusted by organizations across the city
          </p>
          <div className="trust-logos">
            <span>
              <Shield size={24} /> Delhi Civic Corp
            </span>
            <span>
              <HeartHandshake size={24} /> Foundation Trust
            </span>
            <span>
              <Leaf size={24} /> Green City NGO
            </span>
            <span>
              <Users size={24} /> Youth Alliance
            </span>
          </div>
        </div>
      </div>
      ...
      <section id="volunteer-guide" className="page-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              New to Project Delhi? Here is how you can start making an impact
